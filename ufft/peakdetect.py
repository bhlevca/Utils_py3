...
def peakdetect_fft(y_axis, x_axis, pad_len = 5):
    ...
    increase the time domain resolution after performing the inverse ufft and
    ...
    minimize spectral leakage by calculating the ufft between two zero
    ...
    ufft and ifft or change the 'peakdetect' to the 'peakdetect_zero_crossing',
    ...
    # Calculate the ufft between the first and last zero crossing
...
def zero_crossings(y_axis, window = 11):
    ...
    return indices
    # used this to test the ufft function's sensitivity to spectral leakage
