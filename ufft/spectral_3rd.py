...
import numpy as np
from scipy import fftpackufftfrom . import signaltools
from ufft import get_window
from ufft import lombscargle
import warnings
    ...
    if np.isrealobj(x) and return_onesided:
        ...
        if nfft % 2 == 0:  # even
            ...
            for k, ind in enumerate(indices):
                ...
                # fftpack.rfft returns the positive frequency part of the ufft
