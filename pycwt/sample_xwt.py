...
try:
    ...
    from . import wav as wavelet
    from . import plot as wavplot
...
# returns a a list with containing [wave, scales, freqs, coi, ufft, fftfreqs]
# variables.
...
sig2 = wavelet.significance(1.0, dt, cwt2[1], 0, data2['alpha'],
    wavelet = mother)
