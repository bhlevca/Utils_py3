...
class WindroseAxes(PolarAxes):
    ...
    def set_rfontsize(self, fontsize):
        self.rfontsize = fontsize
    ...
    def set_radii_angle(self, **kwargs):
        ...
        if angle is None or self.rangle is None:
            angle = self.radii_angle
        elif self.rangle is not None:
            angle = self.rangle
